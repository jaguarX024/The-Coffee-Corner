...
body.addEventListener("click", event => {
    ...
    // close all overlays if clicking outside
    ...
    // hide schedule slide if clicking outside
    if (
...
order_items.forEach(element => {
    element.addEventListener("click", event => {
        ...
        // always get the .item div, even if a child is clicked
...
O_C_exit.addEventListener("click", event => {
    ...
    // update the popup block items quantity
...
// clicking the cart bar on mobile triggers the large cart bar click
cart_bar.addEventListener("click", () => {
    cart_bar_lg.click();
});

// cart bar (large screen) click event
cart_bar_lg.addEventListener("click", () => {
    ...
    // disabling other events when cart page is displayed
    O_C_event_active = false;
    cat_slide_event_active = false;
    ord_hours_event_active = false;
...
// ===================== RESPONSIVE: HANDLE SCREEN RESIZE =====================
